# GPTZero: Visual Design Specification (Phase 10.5)
...
## 1. Technical Architecture: The "Authorship Provenance" Gated Stack
This diagram visualizes the transition from static detection to process verification.
- **Input Nodes**: Dual entry points for "Static Text" and "Keystroke Telemetry" (Origin).
...
## 3. Growth & Unit Economics: The AI Profitability Curve
This graph proves the rare capital efficiency of GPTZero.
- **X-Axis**: Time (Jan 23 Launch to 2025E).
- **Y-Axis**: ARR ($0 to $24M).
- **Trajectory Line**: 253% YoY growth curve.
- **Milestones**: 
    - **May 2023**: Seed ($3.5M).
